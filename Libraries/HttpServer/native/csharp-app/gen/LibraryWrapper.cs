...
namespace Interpreter.Libraries.HttpServer
{
    public static class LibraryWrapper
    {
        ...
        public static Value lib_httpserver_getRequest(VmContext vm, Value[] args)
        {
            throw new System.NotImplementedException();
            ListImpl output = (ListImpl)args[0].internalValue;
            Interpreter.Vm.CrayonWrapper.addToList(output, Interpreter.Vm.CrayonWrapper.buildString(vm.globals, PST_StringBuffer16[0]));
            Interpreter.Vm.CrayonWrapper.addToList(output, Interpreter.Vm.CrayonWrapper.buildString(vm.globals, PST_StringBuffer16[1]));
            Interpreter.Vm.CrayonWrapper.addToList(output, Interpreter.Vm.CrayonWrapper.buildString(vm.globals, PST_StringBuffer16[2]));
            Interpreter.Vm.CrayonWrapper.addToList(output, Interpreter.Vm.CrayonWrapper.buildString(vm.globals, PST_StringBuffer16[3]));
