...
namespace Parser
{
    internal class ScopeManager
    {
        ...
        private LocalizedAssemblyView GetOrImportAssemblyImpl(ParserContext parser, Token throwToken, string fullImportNameWithDots)
        {
            ...
            CompilationScope compilationScope = new CompilationScope(parser.CompileRequest.BuildContext, assemblyMetadata, assemblyMetadata.InternalLocale, programmingLanguage);
