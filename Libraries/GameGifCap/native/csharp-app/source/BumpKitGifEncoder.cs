...
namespace Interpreter.Libraries.GameGifCap
{
    ...
    /// </summary>
    public class BumpKitGifEncoder : IDisposable
    {
        ...
        public BumpKitGifEncoder(Stream stream, int? width = null, int? height = null, int? repeatCount = null)
        {
            _stream = stream;
            _width = width;
            _height = height;
