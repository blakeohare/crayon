	...
	internal abstract class AbstractSystemFunctionTranslator
	{
		...
		public void Translate(string tab, List<string> output, SystemFunctionCall functionCall)
		{
			...
			switch (name)
			{
				...
				case "_get_image": VerifyCount(functionCall, 1); TranslateGetImage(output, args[0]); break;
				case "_get_image_height": VerifyCount(functionCall, 1); TranslateGetImageHeight(output, args[0]); break;
				case "_get_image_width": VerifyCount(functionCall, 1); TranslateGetImageWidth(output, args[0]); break;
				...
				case "_is_image_loaded": VerifyCount(functionCall, 1); TranslateIsImageLoaded(output, args[0]); break;
		...
		protected abstract void TranslateGetImage(List<string> output, Expression imageKey);
		protected abstract void TranslateGetImageHeight(List<string> output, Expression image);
		protected abstract void TranslateGetImageWidth(List<string> output, Expression image);
		...
		protected abstract void TranslateIsImageLoaded(List<string> output, Expression key);
